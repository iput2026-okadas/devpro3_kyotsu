...
#
# Usage:
# 1. Start the week08 server in another terminal:
#    python week08/my-server-3wayfix.py
#
# 2. Send fake sensor data to the server:
#    python week08/fake_sensor_client.py
#
# 3. Send a specific test scenario:
#    python week08/raspi/fake_sensor_client.py --scenario rising_co2
#
# 4. Create a CSV file directly without using the server:
#    python week08/raspi/fake_sensor_client.py --csv-out week08/data-test.csv --scenario hot_room -c 30
#
# Scenarios:
